...
## Regresión Ordinal {visibility="uncounted"}
...
## Regresión Ordinal {auto-animate=true, visibility="uncounted"}
...
<br>
$$logit [Y \color{red}{\le k}] = log \left[\frac{P(Y \color{red}{\le k})}{1-P(Y \color{red}{\le k})} \right] = \tau_{\color{red}{k}} \color{red}{-} \beta_1 x_1 \color{red}{-} \beta_2 x_2 \color{red}{-} ... \color{red}{-} \beta_p x_p$$
:::
:::
:::
