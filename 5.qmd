...
```{r}
tbl.selected.logistic <- modelsummary(list("Improve (A>B)" = glmer_improve_subject_question, "Level == 'Positivo'" = glmer_positive_treat_subject_question), gof_omit = "RMSE|R2|ICC", output = "kableExtra")
``` 
