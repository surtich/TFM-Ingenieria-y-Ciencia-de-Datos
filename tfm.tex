...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Pregunta de investigación}, colback=white, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, left=2mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm, toprule=.15mm, bottomtitle=1mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white]
...
edición de 2022 del curso MOOC Materiales Digitales Accesibles,
...
Emilio Letón Molina y Alejandro Rodríguez Ascaso. El Canal se creó en
2016 y hasta mayo de 2021 más de 16.000 estudiantes se han inscrito en
sus cursos. Ofrece formación en conocimientos y habilidades necesarios
para diseñar productos, entornos, sistemas y servicios desde una
perspectiva de diseño universal:
...
3.764 alumnos y aprobaron el 19,34\% de ellos.
...
adecuadas. Por ello, se responderá al siguiente objetivo específico:

\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Objetivos específicos}, colback=white, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, left=2mm, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, arc=.35mm, toprule=.15mm, bottomtitle=1mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white]
...
(valores 4 ó 5) y cero cuando no lo sea (valores 1, 2, 3). En la
...
efectos aleatorios (\(ICC\)) es 0.575.
...
se reduce a 48.2\%. Por último, el valor de \(ICC\) del modelo es0.604
...
el ciego} y se responden a las preguntas de investigación planteadas en
la Sección~\ref{sec-objetivos}. Se reveló que el subtitulado que en este
trabajo se ha denominado \(A\) se corresponde que el vídeo correctamente
subtitulado. Adicionalmente se ha suministrado un documento que contiene
los errores introducidos en el subtitulado \(B\). A partir del mismo, se
ha elaborado la Tabla \ref{tbl-blind-errors} en la que se muestra la
correspondencia de cada error con los ítems de la escala de Likert a la
que respondieron los estudiantes (ver en la Tabla~\ref{tbl-likert-scale}
una descripción textual de cada ítem). Para 7 de los 18 ítems (Q01, Q03,
Q04, Q13, Q15, Q16, Q17) no se ha encontrado una adscripción clara en el
documento de errores y, por lo tanto, sería deseable una valoración
...
\tightlist
\item
  Regresión Logística con variable respuesta \texttt{Improve}, que
...
\item
  Regresión Logística con variable respuesta \texttt{Positive}, que
  calcula la probabilidad de que la respuesta a un ítem sea positiva (4
  ó 5).
\item
  Regresión Ordinal con variable Respuesta \texttt{Response}, que
...
en los que no se han introducido errores (en los ítems comoo el \(Q01\)
y \(Q03\) con mucha incertidumbre). También han sido capaces de
identificar correctamente errores de subtitulado en \(Q05\) (la
corrección ortográfica y gramatical), \(Q06\) (la literalidad), \(Q07\)
(la identificación de los personajes), \(Q08\) (la asignación de líneas
a los personajes en los diálogos), \(Q09\) (la descripción de efectos
...
\(Q16\) y \(Q17\) son ítems que tienen una valoración comparativamente
baja en ambos subtitulados e inferior en el \(B\) que en el \(A\) y
ninguna de estas cosas era esperable que sucediera ya que no se han
introducido este tipo de errores.
...
En el subtitulado \(B\) esperamos que los ítems en los que se han
...
\item
  ...
  También se observa diferencias a lahora de valoran un ítem en el que
  no tienen recurdo, dándose todo tipo de situaciones: Contestar
  \enquote{No sé / No contesto}, contestar \enquote{Neutral} e incluso
  valorar positiva y negativamente.
\end{itemize}
...
si los estudiantes de un curso de accesibilidad son capaces de
identificar los errores en el subtitulado de un vídeo, y como objetivos
secundarios averiguar qué aspectos del subtitulado han sido más
...
explica la respuesta a cada ítem. Los efectos secuencia y periodo son de
poca importancia y se traducen en que en general los estudiantes valoran
comparativamente peor el vídeo visto en el segundo periodo para un mismo
nivel de subtitulado. Las variables estudiante e ítem se han tratado
como efectos aleatorios por haber considerado que sus observaciones no
son independientes. La varianza explicada por la variable estudiante ha
sido más grande que la explicada por la variable ítem.
...
minuciosa. En los que sí lo requieren, algunos estudiantes han
...
el fondo) y \(Q13\) (la legibilidad de la tipografía). Esto implica
...
respuestas de este nivel reciben pero que esta respuesta no masiva.
...
\item
  ...
  nacimiento, el nivel de estudios, el grado de conocimientos previo. En
  el momento de realizar este trabajo se disponía de esta información
  aunque de forma muy incompleta ya que la mayoría de los estudiantes
  participantes no suministraron la información personal.
\item
...
\item
  Analizar los datos de la edición del curso de 2023 y posteriores para
  ver en qué medida los modelos y las conclusiones se mantienen o
  cambian.
\item
  Plantear mejoras en la recojida de datos como, por ejemplo,
