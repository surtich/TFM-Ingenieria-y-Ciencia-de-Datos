...
fue asignado aleatoriamente. Después de ver cada vídeo, el estudiante respondió una escala de Likert de 18
...
como bayesiano. Las conclusiones de la exploración de los datos y del modelado estadístico son que estudiantes nóveles en accesibilidad
son capaces de evaluar las diferencias de calidad en el subtitulado. Particularmente son capaces de percibir diferencias en la
...
a este documento han contribuido sin duda a hacer mejor este trabajo. 
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, toprule=.15mm, leftrule=.75mm, rightrule=.15mm, opacityback=0, left=2mm, colback=white, breakable, toptitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Pregunta de investigación}, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, titlerule=0mm]
...
\item
  Sería interesante comparar las respuestas de los estudiantes con la
  realizada por un grupo de expertos.
\end{itemize}
