...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, interior hidden, borderline west={3pt}{0pt}{shadecolor}, frame hidden, enhanced, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics{42-Modelado_files/figure-pdf/fig-probs-clmm_treat.period.subject.question-1.pdf}
