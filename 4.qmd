...
^[Se han eleminado las preguntas en las que una de las dos respuestas del usuario ha sido "No sé / No contesto". La comparación realizada es respuesta en $A > B$ frente a $A >= B$.]. Se comprueba que la mayoría de las preguntas superan el 50%, lo que indica que los estudiantes valoran mejor el subtitulado $A$.
