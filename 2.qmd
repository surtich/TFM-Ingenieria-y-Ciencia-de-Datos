...
En este trabajo se estudiarán las diferencias existentes entre dos niveles de subtitulado (uno correcto y otro con errores) a través de las respuestas de los alumnos a los ítems de las escalas de Likert de cada uno de los vídeos (ver @sec-desc). Para ello se propondrán modelos estadísticos adecuados al diseño del experimento.
...
## Modelos Multinivel Generalizado {#sec-multinivel}
