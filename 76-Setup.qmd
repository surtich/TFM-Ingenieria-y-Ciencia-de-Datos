# Creación de los `dataframes df_all` y `df_clean`. {#sec-setup}

Código que transforma los datos preprocesados (ver @sec-preprocess) en los `dataframes` que se usan en el análisis estadístico.
