...
Se pueden comparar los modelos con el test de razón de verosimilitud que se realiza con la función `anova` del paquete `ordinal` [ver @ordinal]. Se comprueba que en este test resulta significativamente mejor el último modelo:
